...
public class BasePanel extends JPanel {
	...
	public BasePanel setLine(String text) {
		// TODO Auto-generated method stub
		super.setBorder(BorderFactory.createTitledBorder(new LineBorder(Color.black), text));
		return this;

	}

	public BasePanel setEmtBorder(int top, int left, int bottom, int right) {
		// TODO Auto-generated method stub
